...
public class ChessLogic {
	...
	/*
	 * used by minmax to test whether moves are valid. 
	 */
	public boolean testMove(int oldX, int oldY, int updatedX, int updatedY) throws InterruptedException, IOException, CloneNotSupportedException {
		Boolean valid = false; 
		try {
	...
	/*
	 * @return true if Piece is in check
